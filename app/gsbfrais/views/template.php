            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav">
                    <?php if ($_SESSION['profilUtil'] == "visiteur médical") : ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                               aria-haspopup="true" aria-expanded="false">Mes frais</a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="voirFicheFrais"
                                   title="Consultation de mes fiches de frais">Voir mes fiches de frais</a>
                            </div>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['profilUtil'] == "administrateur") : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="voirUtilisateurs" title="Gestion des utilisateurs">Gérer les
                                utilisateurs</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['profilUtil'] == "comptable") : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="cloturerFichesFrais" title="Clôturer les fiches de frais">Clôturer
                                les fiches de frais</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="voirFichesFraisEnAttenteValidation"
                               title="Valider les fiches de frais">Valider les fiches de frais</a>
                        </li>
                    <?php endif; ?>

                    <?php if ($_SESSION['profilUtil'] == "délégué régional") : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="voirFichesFraisRegion" title="Fiches frais des collaborateurs">Fiches
                                frais des collaborateurs</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" a href="changerMotPasse" title="Se déconnecter">Changer mon mot de
                                passe</a>
